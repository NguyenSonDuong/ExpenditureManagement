    ...
    public void setEvenDangNhap(){
        bt_dangnhap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HoTroXuLyDataBase.ttNguoiDung(null,DangNhap.this,"NguoiDung");
                String name = edit_nickname.getText().toString();
                String pass = edit_password.getText().toString();
                XuLyDatabase xuLyDatabase = new XuLyDatabase(DangNhap.this,"NguoiDung",null, 1);
                Cursor cursor = xuLyDatabase.traVeKQ("SELECT * FROM NguoiDung WHERE nickName = '"+name+"' AND PassWord = '"+pass+"'");
                if(cursor == null){
